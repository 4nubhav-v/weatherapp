...
export const NavBody = ({ children, className, visible }: NavBodyProps) => {
  return (
    <motion.div
      ...
      className={cn(
        "relative z-60 mx-auto hidden w-full max-w-7xl flex-row items-center justify-between self-start rounded-full bg-neutral-900 px-4 py-2 backdrop-blur-sm lg:flex dark:bg-neutral-50",
  ...
  return (
    ...
    >
      <img
        ...
        height={30}
      />
      <span className="dark:text-black font-medium text-white">Weather App</span>
    </a>
  );
};
...
export const NavbarButton = ({
  ...
  const variantStyles = {
    ...
    secondary: "bg-transparent shadow-none text-white dark:text-black ",
